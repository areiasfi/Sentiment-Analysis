...
# Problem 5
#-------------------------------------------------------------------------------
# qualitatively verification of the algorithms implementation using a 2D dataset from toy_data.txt
...
# Problem 7
#-------------------------------------------------------------------------------
# training and validation accuracy of the 3 algorithms with text data
